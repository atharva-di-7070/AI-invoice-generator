...
<div className={featuresStyles.backgroungBlob1}></div>
<div className={featuresStyles.backgroungBlob2}></div>
<div className={featuresStyles.backgroungBlob3}></div>
...
The minimal, intelligent interface that focuses on what truly
matters. Create, send, and track invoices effortlessly while
